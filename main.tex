...
\begin{document}
	...
	\begin{align}
		...
		S_t^- < h
	\end{align}
		\ksremark{gdzie wartość $h$ jest progiem decyzyjnym.}
		\ksremark{Tu są dwie nierówności. Jak są połączone? Przez `i' czy `lub'?}
		
		
	\subsubsection{EWMA}
	\ksremark{Tytuł po polsku i w nawiasie EWMA}.
	...
	\ksremark{bez nazwy angielskie w tytule}
	...
	\begin{enumerate}
		...
		\item \textbf {Ewaluacja i weryfikacja:} Zestawienie uzyskanych wyników przy pomocy głównych miar (Precyzja, Czułość, F1-Score \ksremark{nazwy miar małymi literami}) oraz sprawdzenie ich rzetelności za pomocą testów statystycznych.
	\end{enumerate}
