...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{fig_01_window_heatmap.png}
	\caption{Macierz korelacji i wpływu dobieranych parametrów na skuteczność modelu.}
	\label{fig:01-window-heatmap}
\end{figure}
...
\section{Badania wstępne - dobór okna kroczącego}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{fig_02_comparison.png}
	\caption{Porównanie skuteczności (Precision, Recall, F1) dla metod statystycznych.}
	\label{fig:02-comparison}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{fig_02_pr_tradeoff.png}
	\caption{Balans pomiędzy precyzją a czułością dla metod statystycznych.}
	\label{fig:02-pr-balance}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{fig_02_heatmap.png}
	\caption{Heatmapa wyników metryk oceny dla metod statystycznych.}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{fig_03_comparison.png}
	\caption{Porównanie skuteczności badanych algorytmów uczenia maszynowego.}
	\label{fig:03-comparison}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{fig_03_pr_tradeoff.png}
	\caption{Kompromis metryk Precision i Recall w modelach uczenia maszynowego.}
	\label{fig:03-pr-balance}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{fig_03_heatmap.png}
	\caption{Zestawienie wyników eksperymentów ML na macierzy ciepła.}
	\label{fig:03-heatmap}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Krzywe uczenia badanych modeli zoptymalizowanych (Deep Learning).}
	\label{fig:04b-curves}
\end{figure}
...
\begin{table}[H]
	...
	\begin{tabular}{lcccc}
		\toprule
		\textbf{Model} & \textbf{Typ} & \textbf{Precision \ksremark{po polsku}} & \textbf{Recall \ksremark{po polsku}} & \textbf{F1-Score} \\
		\midrule
		IQR & Stat. & ... & ... & ... \\
		Z-Score & Stat. & ... & ... & ... \\
		Z-Score zmodyfikowany & Stat. & ... & ... & ... \\
		CUSUM & Stat. & ... & ... & ... \\
		EWMA & Stat. & ... & ... & ... \\
		Isolation Forest & ML & ... & ... & ... \\
